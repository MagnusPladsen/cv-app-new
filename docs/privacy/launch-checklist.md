...
| Cookieless analytics, or a compliant consent banner | done | Vercel Web Analytics: no cookie and no browser storage, so no banner is required under *ekomloven § 3-15*. What it collects is in the policy, and the test fails if that disappears |
